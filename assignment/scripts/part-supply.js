...
console.log('The supplyChanges array: ', supplyChanges);
...
for (part of supplyChanges){
  if (part > 0)
  stretchPositives.push(part)
 else if (part === 0)
  stretchZeroes.push(part)
 else if (part < 0)
   stretchNegatives.push(part)
}
console.log('The supplyChanges array: ', supplyChanges);
...
supplyChanges = [ 3, 5, -6, 0, 7, 25 ] // needed to refill the array
let totalParts = 0
...
console.log('all said and done: ', totalParts);
